...
import type { ProfesorCreatePageProps } from '@/domain/profesores'

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Profesores', href: '/profesores' },
    { title: 'Crear', href: '/profesores/create' },
]

export default function Create({ roles, permissions }: ProfesorCreatePageProps) {
                ...
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Registrar un nuevo profesor en la plataforma
                            </p>
                        </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Complete todos los campos requeridos para registrar el profesor
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                {permissions && Object.keys(permissions).length > 0 && (
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                                            El rol de profesor ya incluye permisos básicos. Aquí puede agregar permisos especiales.
                                        </p>
