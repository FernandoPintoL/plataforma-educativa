...
import type { EstudianteEditPageProps } from '@/domain/estudiantes'
...
export default function Edit() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Editar Estudiante: ${estudiante.name}`} />
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200 flex items-center">
                                ...
                                Editar Estudiante: {estudiante.name} {estudiante.apellido}
                            </h2>
                                ...
                                {permissions && Object.keys(permissions).length > 0 && (
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                                            El rol de estudiante ya incluye permisos básicos. Aquí puede modificar permisos especiales.
                                        </p>
