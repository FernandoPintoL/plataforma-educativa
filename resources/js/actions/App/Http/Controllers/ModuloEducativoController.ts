...
const ModuloEducativoController = { index, show, create, store, edit, update, destroy, publicar, archivar, reordenar, duplicar }

export default ModuloEducativoController