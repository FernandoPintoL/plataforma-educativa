 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Api\EvaluacionesApiController::iniciarIntento
 * @see app/Http/Controllers/Api/EvaluacionesApiController.php:152
 * @route '/api/api/evaluaciones-intentos/{id}/iniciar'
 */
export const iniciarIntento = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: iniciarIntento.url(args, options),
    method: 'post',
})

iniciarIntento.definition = {
    methods: ["post"],
 ...
 * @route '/api/api/evaluaciones-intentos/{id}/iniciar'
 */
iniciarIntento.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return iniciarIntento.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/api/api/evaluaciones-intentos/{id}/iniciar'
 */
iniciarIntento.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: iniciarIntento.url(args, options),
    method: 'post',
})
 ...
 * @route '/api/api/evaluaciones-intentos/{id}/iniciar'
 */
    const iniciarIntentoForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: iniciarIntento.url(args, options),
        method: 'post',
    })
 ...
 * @route '/api/api/evaluaciones-intentos/{id}/iniciar'
 */
        iniciarIntentoForm.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: iniciarIntento.url(args, options),
            method: 'post',
        })
    
    iniciarIntento.form = iniciarIntentoForm
/**
...
/**
* @see \App\Http\Controllers\Api\EvaluacionesApiController::completarIntento
 ...
 */
export const completarIntento = (args: { intentoId: string | number } | [intentoId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: completarIntento.url(args, options),
    method: 'post',
})

completarIntento.definition = {
    methods: ["post"],
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{intentoId}/completar'
 */
completarIntento.url = (args: { intentoId: string | number } | [intentoId: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { intentoId: args }
    }
    ...
    return completarIntento.definition.url
            .replace('{intentoId}', parsedArgs.intentoId.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{intentoId}/completar'
 */
completarIntento.post = (args: { intentoId: string | number } | [intentoId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: completarIntento.url(args, options),
    method: 'post',
})
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{intentoId}/completar'
 */
    const completarIntentoForm = (args: { intentoId: string | number } | [intentoId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: completarIntento.url(args, options),
        method: 'post',
    })
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{intentoId}/completar'
 */
        completarIntentoForm.post = (args: { intentoId: string | number } | [intentoId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: completarIntento.url(args, options),
            method: 'post',
        })
    
    completarIntento.form = completarIntentoForm
/**
...
/**
* @see \App\Http\Controllers\Api\EvaluacionesApiController::obtenerAnalisisIA
 ...
 */
export const obtenerAnalisisIA = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: obtenerAnalisisIA.url(args, options),
    method: 'get',
})

obtenerAnalisisIA.definition = {
    methods: ["get","head"],
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{id}/analisis-ia'
 */
obtenerAnalisisIA.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return obtenerAnalisisIA.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{id}/analisis-ia'
 */
obtenerAnalisisIA.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: obtenerAnalisisIA.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{id}/analisis-ia'
 */
obtenerAnalisisIA.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: obtenerAnalisisIA.url(args, options),
    method: 'head',
})
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{id}/analisis-ia'
 */
    const obtenerAnalisisIAForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: obtenerAnalisisIA.url(args, options),
        method: 'get',
    })
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{id}/analisis-ia'
 */
        obtenerAnalisisIAForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: obtenerAnalisisIA.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/api/evaluaciones-intentos/intentos/{id}/analisis-ia'
 */
        obtenerAnalisisIAForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: obtenerAnalisisIA.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    obtenerAnalisisIA.form = obtenerAnalisisIAForm
const EvaluacionesApiController = { index, show, iniciarIntento, guardarRespuesta, completarIntento, misIntentos, verIntento, obtenerAnalisisIA }

export default EvaluacionesApiController