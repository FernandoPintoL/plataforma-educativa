...
const ContentAnalysisController = { analyze, analyzeEvaluation, generateEvaluation, generateQuestions, validateQuestionsCoherence, health }

export default ContentAnalysisController